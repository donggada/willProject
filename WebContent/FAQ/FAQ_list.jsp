...
<a href="qnawrite.bo" style="float: right; margin-right: 2px; padding-bottom: 3px; ">
<button type="button" class="btn btn-outline-primary">1:1문의하기</button>
</a>
<a href="qnaBoardlist.bo?id=<%=id %>" style="float: right; margin-right: 3px; padding-bottom: 3px;">
